...
<!-- Mirrored from html.phoenixcoded.net/light-able/bootstrap/dashboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Jul 2024 05:48:36 GMT -->
<head>
    <title>Hotel Admin Panle</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="<?= urlOf('assets/images/favicon.svg') ?>" type="image/x-icon" />  

    <!-- map-vector css -->
    <link rel="stylesheet" href="<?= urlOf('assets/css/plugins/jsvectormap.min.css') ?>" />
