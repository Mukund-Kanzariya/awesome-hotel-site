                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0)">Contact From User</a></li>
                ...
                <div class="card border-0 table-card user-profile-list">
                    <div class="card-body">
                        <div class="text-end p-sm-4 pb-sm-2">
                            <!-- <a href="<?=  urlOf('pages/role/addRole') ?>" class="btn custom"> <i
                                    ...
                                    <tr>
                                        ...
                                        <div class="overlay-edit">
                                            <ul class="list-inline mb-0">
                                                ...
                                                <li class="list-inline-item m-0"><a
                                                        href="../../api/role/delete?deleteId=<?= $row['Id'] ?>"
