                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="role">
                                    ...
                                    <option value="<?= $row['Id'] ?>" require><?= $row['Name'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Name</label>
                                <input type="text" class="form-control" placeholder="Enter Name" id="name" require
                                    autofocus />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter E-mail" id="email" require />
                            </div>
                        </div>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter City" id="city" require />
                            </div>
                            <div class="mb-3">
                                <label class="form-label">State</label>
                                <input type="text" class="form-control" placeholder="Enter State" id="state" require />
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-body text-end btn-page">
                            <button class="btn custom mb-0" onclick="sendDate()">Add User</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function(response, status, xhr) {
            if (xhr.status == 200) {
                ...
                alert("User Added Error. Please try again.");
